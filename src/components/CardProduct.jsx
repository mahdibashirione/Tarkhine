...
const CardProduct = ({ data }) => {
  const { auth, cart, interests } = useSelector((state) => state);
  ...
  return (
    <li className="bg-white max-w-[300px] mx-auto w-full col-span-1 flex-nowrap justify-between select-none min-w-fit rounded-xl border border-[#cbcbcb] overflow-hidden items-center flex flex-col">
      {/* image */}
      <div className="w-full relative h-[170px] md:h-[200px] lg:h-[220px]">
        <img
        ...
        {isInCart >= 0 ? (
          ...
          <ButtonContain
            onClick={(e) => {
              ...
              successToast("لطفا وارد حساب کاربری خود شوید");
            }}
            className="w-full"
