...
const Navbar = ({ isShow = false, handleClose }) => {
  ...
  return (
    <nav
      className={`${
        isShow ? "block" : "hidden"
      } h-screen w-screen top-0 flex duration-200 overflow-hidden lg:hidden bg-transparent fixed right-0 z-30`}
    >
      <motion.div
        initial={{ maxWidth: 0 }}
        animate={isShow ? { maxWidth: 256 } : { maxWidth: 0 }}
        transition={{ duration: 0.3 }}
        className="w-full h-full bg-white"
      >
        <div className="w-full h-24 bg-[url('/images/topFrame.png')] relative flex items-center px-4 ">
          <img className="w-20" src="/images/LogoWhite.svg" alt="لوگو-ترخینه" />
          <button
            onClick={handleClose}
            className="absolute text-white text-3xl top-4 left-4"
          >
            <FiX />
          </button>
        </div>
        <div className="p-4 flex flex-col gap-6">
          ...
          <Accurdion
            icon={
              ...
              >
                <path
                  ...
                  fill={`${branch !== "شعبه" ? "#417F56" : "#353535"}`}
                />
                <path
            ...
            isInPage={branch !== "شعبه" ? branch : false}
            title={branch !== "شعبه" ? `شعبه ${branch}` : "شعبه"}
          >
            {barnches.map((branch) => {
              return (
                <Link
          ...
          <Accurdion
            icon={
              ...
              >
                <path
                  ...
                  fill={`${pathname === "/menu" ? "#417F56" : "#353535"}`}
                />
                <path
            ...
            isInPage={pathname === "/menu" ? true : false}
            title="منو"
          >
            {menus.map((branch) => {
              return (
          ...
          >
            ...
            >
              <path
                ...
                fill={`${pathname === "/aboutme" ? "#417F56" : "#353535"}`}
              />
              <path
          ...
          >
            ...
            >
              <path
                ...
                fill={`${pathname === "/callme" ? "#417F56" : "#353535"}`}
              />
              <path
          ...
          {/* <Link
            onClick={handleClose}
            className={`${pathname === "/namayandegi" && "text-primary"}`}
            to="/namayandegi"
          >
            اعطای نمایندگی
          </Link> */}
      ...
      <motion.div
        ...
        className="w-full h-full flex-1 bg-zinc-900/50 backdrop-blur"
      ></motion.div>
    </nav>
  );
};
