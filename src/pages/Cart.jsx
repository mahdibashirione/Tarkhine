  ...
  const steps = [
    {
      ...
      view: <ProductList activeStep={activeStep} handleNext={handleNext} />,
    },
    {
      id: 1,
      title: "تکمیل اطلاعات",
    ...
    <section className="container px-4 select-none">
      ...
      {cart.length <= 0 && (
        <article className="w-full flex flex-col items-center gap-6 mb-8 mt-4 border py-32 bg-[url('/images/EmptyPage.png')] bg-center bg-no-repeat border-[#cbcbcb] rounded-lg px-4">
          ...
          <Link
            className="text-primary border-primary border rounded py-3 px-8 lg:text-lg lg:px-12"
            to="/"
          >
            منوی رستوران
          </Link>
          ...
          <div className="border-[#cbcbcb] w-full h-fit lg:w-1/3 p-6 border rounded-lg">
            ...
            <div className="w-full flex justify-between gap-2">
              {activeStep > 0 && (
                <button
                  onClick={handleBack}
                  className="hidden md:flex gap-2 items-center justify-center flex-1 rounded py-2 mt-4 bg-primary text-white "
                >
                  <FiChevronRight />
                  مرحله قبل
                </button>
              ...
              <button
                onClick={handleNext}
                className="flex gap-2 items-center justify-center flex-1 rounded py-2 mt-4 bg-primary text-white "
              >
